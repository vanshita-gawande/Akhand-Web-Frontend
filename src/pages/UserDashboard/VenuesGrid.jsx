      ...
      {venues.length === 0 ? (
        ...
        >
          {venues.map((venue) => (
            <div
              key={venue._id}
              className="max-w-[22rem] w-full mx-auto bg-white rounded-xl shadow-md hover:shadow-lg transition-transform transform hover:-translate-y-1 flex flex-col"
            >
              {/* Card Header */}
              <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-purple-100 via-pink-50 to-white rounded-t-xl border-b border-gray-200">
